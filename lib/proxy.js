    ...
    return new Proxy({}, {
        get(target, p, receiver) {
            ...
            if (p === 'length') {
                ...
                return function() {
                    return String.prototype.charAt.apply(__concreteval__, arguments.slice());
                }
            }
                ...
                || p === 'sub' || p === 'sup') {
                return function() {
                    return makeProxyString(String.prototype[p].apply(__concreteval__, arguments.slice()));
                }
            }

            else if (p === 'split') {
                return function() {
                    let array = String.prototype.split.apply(__concreteval__, arguments.slice());
            ...
            if (keys.length === 0) {
                return randomChoice(
                    ...
                    function() {
                        ...
                        target[arbitraryString] = randomChoice(
                            [
                                function() { return makeProxyObject(); },
                                function() { return makeProxyString(); },
