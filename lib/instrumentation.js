            ...
            if (path.isProgram() || path.isBlockStatement()) {
                ...
                for (let item of path.node.body) {
                    if (item.type === 'FunctionDeclaration') {
                                                        ...
                                                        babelTypes.objectExpression(
                                                            [
                                                                babelTypes.objectProperty(
                                                                    ...
                                                                    babelTypes.numericLiteral(item.loc.start.line),
                                                                    false
                                                                ),
                                                                babelTypes.objectProperty(
                                                                    babelTypes.identifier('column'),
                                                                    babelTypes.numericLiteral(item.loc.start.column),
                                                                    false
                                                                ),
                                                                babelTypes.objectProperty(
                                                                    babelTypes.identifier('index'),
                                                                    babelTypes.numericLiteral(item.start),
                                                                    false
                                                                ),
                                                            ]
                                                        ),
                                                    ...
                                                    babelTypes.objectProperty(
                                                        ...
                                                        babelTypes.objectExpression(
                                                            [
                                                                babelTypes.objectProperty(
                                                                    babelTypes.identifier('line'),
                                                                    babelTypes.numericLiteral(item.loc.end.line),
                                                                    false
                                                                ),
                                                                babelTypes.objectProperty(
                                                                    babelTypes.identifier('column'),
                                                                    babelTypes.numericLiteral(item.loc.end.column),
                                                                    false
                                                                ),
                                                                babelTypes.objectProperty(
                                                                    babelTypes.identifier('index'),
                                                                    babelTypes.numericLiteral(item.end),
                                                                    false
                                                                ),
                                                            ]
                                                        ),
                        ...
                        functionDecls.push(babelTypes.expressionStatement(objectDefinePropertyExpr));
                    } else {
...
function instrumentCodeWithTaints(sourceCode, filename, taintInfo) {
    ...
    babelTraverse(ast, {
        exit: function (path) {
            if (isTainted(path.node.start, path.node.end, filename, taintInfo)) {
                path.replaceWith(
                    babelTypes.callExpression(
                        babelTypes.functionExpression(
                            null,
