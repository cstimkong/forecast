 ...
 * @returns 
 */
export function instrumentCodeForForcedExecution(source, filename, opts) {
        ...
        exit: function (path, state) {
            if (path.isMemberExpression() && !(path.parentPath.isAssignmentExpression() && path.parentKey === 'left')) {
                                            ...
                                            babelTypes.objectExpression(
                                                [
                                                    babelTypes.objectProperty(
                                                        ...
                                                        babelTypes.stringLiteral('taintInfo')
                                                    ),
                                                    babelTypes.objectProperty(
                ...
                if (path.get('left').isMemberExpression()) {
                    let objectReplacement = babelTypes.callExpression(
                            ...
                            babelTypes.functionExpression(
                                ...
                                babelTypes.blockStatement(
                                    [
                                                ...
                                                [
                                                    babelTypes.objectExpression(
                                                        [
                                                            babelTypes.objectProperty(
                                                                babelTypes.identifier('line'),
                                                                babelTypes.numericLiteral(path.get('left').get('object').node.loc.start.line),
                                                                false
                                                            ),
                                                            babelTypes.objectProperty(
                                                                babelTypes.identifier('column'),
                                                                babelTypes.numericLiteral(path.get('left').get('object').node.loc.start.column),
                                                                false
                                                            ),
                                                            babelTypes.objectProperty(
                                                                babelTypes.identifier('index'),
                                                                babelTypes.numericLiteral(path.get('left').get('object').node.start),
                                                                false
                                                            ),
                                                        ]
                                                    ),
                                                    babelTypes.objectExpression(
                                                        [
                                                            babelTypes.objectProperty(
                                                                babelTypes.identifier('line'),
                                                                babelTypes.numericLiteral(path.get('left').get('object').node.loc.end.line),
                                                                false
                                                            ),
                                                            babelTypes.objectProperty(
                                                                babelTypes.identifier('column'),
                                                                babelTypes.numericLiteral(path.get('left').get('object').node.loc.end.column),
                                                                false
                                                            ),
                                                            babelTypes.objectProperty(
                                                                babelTypes.identifier('index'),
                                                                babelTypes.numericLiteral(path.get('left').get('object').node.end),
                                                                false
                                                            )
                                                        ]
                                                    ),
                                                    ...
                                                    babelTypes.objectExpression(
                                                        [
                                                            babelTypes.objectProperty(
                                                                babelTypes.identifier('type'),
                                                                babelTypes.stringLiteral('objectCreation')
                                                            ),
                                                            babelTypes.objectProperty(
                                                                babelTypes.identifier('value'),
                                                                babelTypes.callExpression(
                                                                    babelTypes.identifier('__getcreationlocation__'),
                                                                    [babelTypes.identifier('e')]
                                                                )
                                                            )
                                                        ]
                                        ...
                                        babelTypes.returnStatement(babelTypes.identifier('e'))
                                    ]
                                )
                            )
                ...
                let newCallExpr = babelTypes.callExpression(
                    ...
                    [
                        path.node,
                        babelTypes.stringLiteral('__creationlocation__'),
                        babelTypes.objectExpression(
                            [
                                babelTypes.objectProperty(
                                ...
                                babelTypes.objectProperty(
                                    ...
                                    babelTypes.objectExpression(
                                        [
                                            ...
                                            babelTypes.objectProperty(
                                                babelTypes.identifier('filename'),
                                                typeof filename == 'string' ? babelTypes.stringLiteral(filename) : babelTypes.identifier('undefined')
                                            )
                                        ]
                                    )
            ...
            /* Instrumentation for recording the function values in calls */
                                                ...
                                                [
                                                    ...
                                                    babelTypes.objectExpression(
                                                        [
                                                            babelTypes.objectProperty(
                                                                babelTypes.identifier('type'),
                                                                babelTypes.stringLiteral('funcDef')
                                                            ),
                                                            babelTypes.objectProperty(
                                                                babelTypes.identifier('value'),
                                                                babelTypes.callExpression(
                ...
                let objectDefinePropertyExpr = babelTypes.callExpression(
                    babelTypes.memberExpression(
                        babelTypes.identifier('Object'),
                        babelTypes.identifier('defineProperty')
                    ),
                ...
                path.insertAfter(
                    babelTypes.expressionStatement(objectDefinePropertyExpr)
                );
...
function isTainted(start, end, filename, taintInfo) {
    for (let e of taintInfo) {
        if (start === e.start && end === e.end && filename === e.filename) {
            return true;
        }
    }
    return false;
 ...
 */
export function instrumentCodeWithTaints(sourceCode, filename, taintInfo) {
                                        ...
                                        [
                                            ...
                                            babelTypes.objectExpression(
                                                [
                                                    babelTypes.objectProperty(
                                                        babelTypes.identifier('type'),
                                                        babelTypes.stringLiteral('taintValue')
                                                    ),
                                                    babelTypes.objectProperty(
                                                        babelTypes.identifier('value'),
                                                        babelTypes.identifier('x')
