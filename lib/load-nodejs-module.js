...
const {instrumentCodeForForcedExecution} = require('./code-instrumentation');

const internalModules = ['module', 'buffer', 'fs', 'path', 'vm', 'process', 'child_process', 'net', 'http', 
    'https', 'tls', 'events', 'crypto', 'stream', 'os', 'url', 'dns', 'util', 'zlib', 'assert', 'tty'
];
...
function loadNodeJSModule(modulePath) {
    ...
    return _loadNodeJSModule(modulePath, true, {});
...
let mod = loadNodeJSModule('/Users/kongdezhen/Projects/FesaJS/node_modules/yargs-parser/');
