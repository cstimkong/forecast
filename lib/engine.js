...
function forcedExecution(f, argCount, thisArg) {
    ...
    try {
        ...
        globalThis.__getcreationlocation__ = __getcreationlocation__;
        f.apply(thisArg, argArray);
        ...
        delete globalThis.__getcreationlocation__;
    }
}
...
function __encodeURI__(uri) {
    return makeProxyString(encodeURI(uri));
}
 ...
 */
function __decodeURI__(uri) {
    return makeProxyString(decodeURI(uri));
}

function __Array_from__(o) {
    // TODO
}
...
function generateExploit(templateArgArray) {
    // TODO
}
